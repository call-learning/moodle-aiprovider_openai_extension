 ...
 */
$string['action:convert_speech_to_text:endpoint'] = 'Endpoint';
$string['action:convert_speech_to_text:endpoint_desc'] = 'Endpoint for the OpenAI STT API (e.g., https://api.openai.com/v1/audio/transcriptions). This is usually not needed as it is set by the OpenAI provider.';
$string['action:convert_speech_to_text:model'] = 'STT model';
$string['action:convert_speech_to_text:model_desc'] = 'Model used to transcribe speech to text (e.g., whisper-1, gpt-4o-transcribe).';
$string['action:convert_speech_to_text:systeminstruction'] = 'System instruction';
$string['action:convert_speech_to_text:systeminstruction_desc'] = 'System instruction to guide the STT model. This can include specific instructions on how to read the text, such as "Read this text aloud in a clear and engaging manner."';
